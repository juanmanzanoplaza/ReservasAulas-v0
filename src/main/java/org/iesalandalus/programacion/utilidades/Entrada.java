...
public class Entrada {
	...
	/**
	 * M�todo estático que lee un entero por teclado y se asegura
	...
	/**
	 * M�todo estático que lee un entero largo (long) por teclado y se asegura
	...
	/**
	 * M�todo estático que lee un real (float) por teclado y se asegura
	...
	/**
	 * M�todo estático que lee un real de doble precisión (double) 

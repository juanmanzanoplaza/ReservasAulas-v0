...
12. Crea el enumerado `Opcion` que será el encargado de representar el men� de opciones de nuestra aplicación y que se adecue al diagrama de clases expuesto. Haz un commit.
...
14. Crea la clase `IUTextual` con los métodos que se especifican y que ser� la encargada de ejecutar cada una de las opciones del men� de nuestra aplicación. Haz un commit.
